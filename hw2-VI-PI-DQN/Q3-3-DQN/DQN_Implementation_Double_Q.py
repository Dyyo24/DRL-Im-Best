...
# =============================================================================
                all_q_value_vec_x = self.Qnet.predict(all_next_state_x, all_action_x) # this step is for double q learning; q-value should be calculated from the online Qnet
